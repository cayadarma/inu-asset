    ...
    <div className="flex flex-col gap-6 pb-10">
      ...
      <div className="bg-white dark:bg-[#1E293B] p-6 rounded-2xl border border-gray-100 dark:border-[#334155] shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
             <h2 className="text-xl font-bold text-[#0F172A] dark:text-[#F8FAFC]">Filter Oli Caterpillar 1R-0751</h2>
             <Badge status="Beroperasi" /> {/* Kita pakai badge hijau untuk 'Tersedia' */}
          </div>
          <div className="flex flex-wrap gap-4 text-sm text-[#64748B]">
            <span>Kode: <span className="font-bold text-[#0F172A] dark:text-[#F8FAFC]">{id}</span></span>
            <span>Kategori: <span className="font-bold text-[#0F172A] dark:text-[#F8FAFC]">Filter</span></span>
            <span>Stok Saat Ini: <span className="font-bold text-[#0D9488]">24 Unit</span></span>
          </div>
        </div>
        <button className="px-6 py-2.5 border border-gray-200 dark:border-[#334155] rounded-xl text-sm font-bold text-[#475569] dark:text-[#94A3B8] hover:bg-gray-50 dark:hover:bg-[#334155]/50 dark:hover:bg-[#334155]/50 transition-all">
          Sesuaikan Stok
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#1E293B] rounded-2xl border border-gray-200 dark:border-[#334155] shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-100 dark:border-[#334155] bg-[#F8FAFC] dark:bg-[#0F172A] dark:bg-[#0F172A] dark:bg-[#0F172A]">
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-50">
                {movements.map((move, i) => (
                  <tr key={i} className="hover:bg-gray-50 dark:hover:bg-[#334155]/50 dark:hover:bg-[#334155]/50/50">
                    <td className="px-6 py-4 font-medium text-[#475569] dark:text-[#94A3B8]">{move.date}</td>
        ...
        <div className="bg-white dark:bg-[#1E293B] p-8 rounded-2xl border border-gray-100 dark:border-[#334155] shadow-sm flex flex-col gap-6">
           <h3 className="font-bold text-[#0F172A] dark:text-[#F8FAFC] dark:text-[#F8FAFC]text-lg">Informasi Supplier</h3>
           <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                 ...
                 <span className="text-[15px] font-bold text-[#0F172A] dark:text-[#F8FAFC] dark:text-[#F8FAFC]flex items-center gap-2">
