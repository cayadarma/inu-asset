    ...
    <div className="flex flex-col gap-6 pb-10 font-poppins text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button className="px-5 py-2.5 bg-white border border-gray-200 rounded-xl font-bold text-sm text-[#475569] hover:bg-gray-50 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-6">
            <h3 className="font-bold text-[#0F172A] text-lg border-b pb-4">Laporan Perbaikan Teknis</h3>
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-[#475569] leading-relaxed bg-[#F8FAFC] p-5 rounded-xl border border-gray-100">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-4">
            <h3 className="font-bold text-[#0F172A] text-base">Bukti Foto (FOTO)</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-4">
             <h3 className="font-bold text-[#0F172A] text-base">Estimasi Biaya</h3>
             <div className="flex justify-between text-sm">
                <span className="text-[#475569]">Total Biaya</span>
                <span className="font-black text-[#0F172A]">Rp 12.500.000</span>
             </div>
          </div>
        </div>
      </div>
...
function RowItem({ label, value }: { label: string, value: string }) {
  return (
    <div className="flex items-center">
      ...
      <span className="text-sm text-[#0F172A] font-bold">{value}</span>
    </div>
  );
}