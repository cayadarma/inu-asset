    ...
    <div className="flex flex-col gap-6 pb-10 font-poppins text-left">
      ...
      <div className="p-6 bg-white dark:bg-[#1E293B] rounded-2xl border border-gray-100 dark:border-[#334155] shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-6">
            <div className="w-20 h-20 bg-[#F1F5F9] rounded-xl overflow-hidden border border-gray-100 dark:border-[#334155] flex items-center justify-center text-gray-400 font-bold">
                ASSET
            </div>
            <div className="flex flex-col gap-1">
                <div className="flex items-center gap-3">
                    <h1 className="text-xl font-bold text-[#0F172A] dark:text-[#F8FAFC]">Genset Caterpillar 3516</h1>
                    <Badge status="Rusak" />
                </div>
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-[#475569] dark:text-[#94A3B8]">
                    <span className="font-bold text-[#0F172A] dark:text-[#F8FAFC]">{id}</span>
        ...
        <Link href={`/registrasi-aset/${slug}/${id}`} className="px-5 py-2 border border-gray-200 dark:border-[#334155] rounded-xl text-sm font-bold text-[#475569] dark:text-[#94A3B8] hover:bg-gray-50 dark:hover:bg-[#334155]/50 dark:hover:bg-[#334155]/50 transition-all">
            Lihat Profil Aset
        </Link>
      </div>
      ...
      <div className="bg-white dark:bg-[#1E293B] rounded-2xl border border-gray-200 dark:border-[#334155] shadow-sm overflow-hidden">
        <div className="px-6 bg-[#F8FAFC] dark:bg-[#0F172A] dark:bg-[#0F172A] dark:bg-[#0F172A] border-b border-gray-200 dark:border-[#334155] flex flex-col md:flex-row justify-between items-center">
          <div className="flex w-full md:w-auto">
            <button 
              onClick={() => setActiveTab("gangguan")}
              className={`px-6 py-5 text-sm font-bold transition-all ${activeTab === "gangguan" ? "text-[#0D9488] border-b-2 border-[#0D9488] bg-white dark:bg-[#1E293B]" : "text-[#94A3B8] hover:text-[#475569] dark:text-[#94A3B8]"}`}
            >
              Record Gangguan (Buku Sakit)
            </button>
            <button 
              onClick={() => setActiveTab("pemeliharaan")}
              className={`px-6 py-5 text-sm font-bold transition-all ${activeTab === "pemeliharaan" ? "text-[#0D9488] border-b-2 border-[#0D9488] bg-white dark:bg-[#1E293B]" : "text-[#94A3B8] hover:text-[#475569] dark:text-[#94A3B8]"}`}
            >
              Record Pemeliharaan
            </button>
          </div>
        ...
        <div className="overflow-x-auto">
          {activeTab === "gangguan" ? (
            <table className="w-full text-left text-sm border-collapse">
              <thead className="bg-[#F1F5F9] border-b text-[#475569] dark:text-[#94A3B8] font-bold uppercase text-[11px] tracking-widest">
                <tr>
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-[#334155] dark:divide-[#334155]">
                <tr className="hover:bg-gray-50 dark:hover:bg-[#334155]/50 dark:hover:bg-[#334155]/50/50 transition-colors">
                  <td className="px-6 py-5 whitespace-nowrap text-[#475569] dark:text-[#94A3B8] font-medium">04 Juli 2024</td>
                  <td className="px-6 py-5 font-bold text-[#0F172A] dark:text-[#F8FAFC]">Kebocoran Radiator</td>
                  <td className="px-6 py-5 text-[#475569] dark:text-[#94A3B8] font-medium">Suryadi</td>
            ...
            <div className="overflow-x-auto animate-in fade-in duration-300">
              <table className="w-full text-left text-sm border-collapse">
                <thead className="bg-[#F8FAFC] dark:bg-[#0F172A] dark:bg-[#0F172A] dark:bg-[#0F172A] border-b text-[#475569] dark:text-[#94A3B8] font-bold uppercase text-[11px] tracking-widest">
                  <tr>
                    <th className="px-6 py-4">Tanggal</th>
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-[#334155] dark:divide-[#334155]">
                  ...
                  {[
                    ...
                    <tr key={i} className="hover:bg-gray-50 dark:hover:bg-[#334155]/50 dark:hover:bg-[#334155]/50/50 transition-colors">
                      <td className="px-6 py-5 text-[#475569] dark:text-[#94A3B8] whitespace-nowrap">{item.date}</td>
                      ...
                      <td className="px-6 py-5 font-bold text-[#0F172A] dark:text-[#F8FAFC]">{item.task}</td>
                      <td className="px-6 py-5 text-[#475569] dark:text-[#94A3B8]">{item.tech}</td>
                      <td className="px-6 py-5 text-center">
      ...
      <Modal isOpen={isRecordModalOpen} onClose={() => setIsRecordModalOpen(false)} title="Laporkan Kerusakan Aset">
        <form className="grid grid-cols-1 lg:grid-cols-3 gap-10 text-left">
          <div className="lg:col-span-2 flex flex-col gap-5">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-[#0F172A] dark:text-[#F8FAFC]">Aset Terkait</label>
                <input type="text" value={`${id} - Genset Caterpillar 3516`} disabled className="p-3 border border-gray-200 dark:border-[#334155] rounded-xl bg-[#F8FAFC] dark:bg-[#0F172A] dark:bg-[#0F172A] dark:bg-[#0F172A] text-sm font-bold text-[#94A3B8] cursor-not-allowed" />
              </div>
              <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" placeholder="Masukkan nama pelapor" className="p-3 border border-gray-200 dark:border-[#334155] rounded-xl text-sm outline-none focus:border-primary" />
              </div>
              <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input type="text" placeholder="Contoh: Kebocoran Oli" className="p-3 border border-gray-200 dark:border-[#334155] rounded-xl text-sm outline-none focus:border-primary" />
            </div>
            <div className="flex flex-col gap-2">
          ...
          <div className="lg:col-span-1 flex flex-col gap-5">
            <label className="text-sm font-bold text-[#0F172A] dark:text-[#F8FAFC]">Foto Bukti</label>
            ...
            <div className="flex flex-col gap-3 mt-auto pt-6">
              ...
              <button type="button" onClick={() => setIsRecordModalOpen(false)} className="w-full bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-[#334155] text-[#475569] dark:text-[#94A3B8] py-4 rounded-xl font-bold text-sm">Batalkan</button>
            </div>
          </div>
        </form>
      </Modal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left">
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-lg font-bold text-[#0F172A] dark:text-[#F8FAFC]">Kebocoran Radiator</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <span className="text-xs font-bold text-[#94A3B8] uppercase">Pelapor</span>
                <p className="text-sm font-bold text-[#0F172A] dark:text-[#F8FAFC]">Suryadi</p>
              </div>
              <div>
                <span className="text-xs font-bold text-[#94A3B8] uppercase">Tanggal</span>
                <p className="text-sm font-bold text-[#0F172A] dark:text-[#F8FAFC]">04 Juli 2024</p>
              </div>
            </div>
            <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full aspect-video bg-gray-100 rounded-xl overflow-hidden border border-gray-200 dark:border-[#334155]">
